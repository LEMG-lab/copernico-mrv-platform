            ...
            <div className="bg-slate-900/50 p-4 rounded border border-slate-700/50 font-mono text-xs flex flex-col md:flex-row justify-between md:items-center gap-4 relative overflow-hidden">
                ...
                <div className="text-right md:min-w-[200px] z-10 flex flex-col items-end gap-2">
                    ...
                    <div className="mt-2">
                        ...
                        {status === 'verified' && (
                            <a href="https://explorer.globalforce.io/transaction/a44b8630b7072fd0b1689e781b9e5a786f97bdd3d9a5fdee2a7707e258426cd3" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 inline-block text-[10px] flex items-center gap-1 justify-end">
